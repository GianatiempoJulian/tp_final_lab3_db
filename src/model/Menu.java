        ...
        while (eleccionWhile == 0) {
            ...
            switch (opcion) {
                ...
                case 3:
                    ...
                    if (booleanEleccion == 0) ///AcÃ¡ no hay tanta libertad, solo es true o false. Si es true, se pasa auto. a false, y viceversa.
                    {
        ...
        while (eleccionWhile == 0) {
            ...
            case 2:
                ...
                case 5:
                    ...
                    System.out.println("Â¿Quiere cambiarlo? [Si=0] [No=1]");
                    booleanEleccion = scanner.nextInt();
                    if (booleanEleccion == 0) ///AcÃ¡ no hay tanta libertad, solo es true o false. Si es true, se pasa auto. a false, y viceversa.
                    {
                        if (c.get_isFighter()) {
